...
class DataClass(Dataset):
    def __init__(self, args, filename):
        ...
        elif args['--lang'] == 'Indonesian':
            self.bert_tokeniser = AutoTokenizer.from_pretrained("cahya/bert-base-indonesian-1.5G")
    ...
    def process_data(self):
        ...
        if self.args['--lang'] == 'English':
            ...
            # ira anticipaciÃ³n asco miedo alegrÃ­a amor optimismo pesimismo tristeza sorpresa or confianza?
            segment_a = "ira anticip asco miedo alegr amor optimismo pesimismo tristeza sorpresa or confianza?"
            label_names = ['ira', 'anticip', 'asco', 'miedo', 'alegr', 'amor', 'optimismo',
                           'pesim', 'tristeza', 'sorpresa', 'confianza']

        elif self.args['--lang'] == 'Indonesian':
            segment_a = "tekno militer politik lingkungan ekonomi budaya masyarakat or lainnya?"
            label_names = ["tekn", "militer", "politik", "lingkungan", "ekonomi", "budaya", "masyarakat", "lainnya"]
